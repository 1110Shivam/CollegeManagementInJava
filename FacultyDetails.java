...
public class FacultyDetails {
    ...
    FacultyDetails(){
        ...
        sp.setBounds(20,20,1870,500);
        fr.add(sp);
        
        fr.getContentPane().setBackground(Color.WHITE);

        l1 = new JLabel("Enter employee id to delete faculty :");
        l1.setBounds(50,600,650,40);
        l1.setFont(new Font("Sans serif",Font.BOLD,35));
        fr.add(l1);
        
        t = new JTextField();
        t.setBounds(700,600,400,40);
        t.setFont(new Font("Sans serif",Font.BOLD,30));
        fr.add(t);
        
        b1 = new JButton("Delete");
        b1.setBounds(1150, 600, 150 ,40);
        ...
        l2.setBounds(50,750,300,40);
        l2.setFont(new Font("Sans serif",Font.BOLD,30));
        fr.add(l2);

        b2 = new JButton("Add");
        b2.setBounds(450, 750, 150 ,40);
        ...
        l3.setBounds(50,850,350,40);
        l3.setFont(new Font("Sans serif",Font.BOLD,30));
        fr.add(l3);
            
      
        b3 = new JButton("Update");
        b3.setBounds(450, 850, 150 ,40);
